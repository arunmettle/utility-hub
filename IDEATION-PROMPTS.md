...
## Civil Utility Ideation Prompt

Use this when evaluating the next UtilityHub civil or construction tool:

```md
You are evaluating browser-based utility tools for working civil, site, hydraulic, and construction engineers.

Context:
- UtilityHub is privacy-first and client-side
- The goal is not to clone BIM, CAD, PMIS, estimating suites, or GIS
- The goal is to replace messy spreadsheets, repetitive document review, tender-stage calculations, and awkward field-to-office utility work
- Prefer workflows engineers repeat weekly or daily

Instructions:
1. Start from real civil-engineering pain points, not generic productivity ideas.
2. Prioritize workflows engineers already do in Excel, PDFs, markups, hand calculations, specs, or exported schedules.
3. Reject ideas that mainly belong inside CAD, BIM, GIS, scheduling suites, or full estimating platforms unless a smaller browser-local wedge exists.
4. For each idea, score:
   - frequency of use
   - pain severity
   - trust requirement
...
5. Prefer tools that:
   - save time immediately
   - reduce coordination or revision risk
   - make assumptions visible
   - help both design-office and field-review work
   - can be used without training
6. Avoid tools that only sound impressive but do not beat a spreadsheet or redline review in day-to-day value.
